...
import mybatisTest.bean.Employee;
import mybatisTest.dao.EmployeeMapper;
...
public class MyBatisTest {
    ...
    public void test() throws IOException {
        ...
        try {
            Employee employee = openSession.selectOne("mybatisTest.dao.EmployeeMapper.getEmpById", "张三");
    ...
    public void test01() throws IOException {
        ...
        try {
            ...
            Employee employee = mapper.getEmpById(1);//mapper是一个代理对象,mybatis自动创建的一个代理对象
